...
ChatEngine = ChatEngineCore.create({
    publishKey: 'pub-c-13646751-f0ab-4393-8ea6-3dab139d38b8',
    subscribeKey: 'sub-c-a8341f98-10ee-11e8-92ea-7a3d09c63f1f'
});
...
const init = () => {
  ...
  ChatEngine.connect(newPerson.uuid, newPerson);
    ...
    function onDeviceReady() {
        ...
        console.log(navigator.notification);console.log(navigator.notification);
    }
  ...
  ChatEngine.on('$.ready', function(data) {
      ...
      myChat.on('message', (message) => {
          ...
          vibration();
          console.log("test vibrate on msg recv");
      });
